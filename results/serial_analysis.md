...
Auto-generated by `scripts/analyze_serial.py` from `results/baseline_results.md` and `results/perf_stat_polblogs_*.txt`.
...
## 6. Noise floor (5-run spread on polblogs)
...
| Noise floor (sec.6)           | Significance threshold for scaling plots |
...
Regenerate with: `python3 scripts/analyze_serial.py`
